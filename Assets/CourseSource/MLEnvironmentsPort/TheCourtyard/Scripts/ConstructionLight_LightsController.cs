...
[ExecuteAlways]
public class ConstructionLight_LightsController : MonoBehaviour
{
    [Header("Lamp State")]
    ...
    public Renderer _LightBulb;   // Shader: MLC_CourtYard_Standard_Specular
    public Renderer _LightReflector;   // Shader: MLC_CourtYard_Standard_Specular
    ...
    public void TurnOn()
    {
        ...
        _mpbA.SetColor("_Multiply_Emissive_Color", _emissiveOn);
    ...
    public void TurnOff()
    {
        ...
        if (_LightBulb == null) return;
        _LightBulb.GetPropertyBlock(_mpbA);
        _mpbA.SetColor("_Multiply_Emissive_Color", _emissiveOff);
        _LightBulb.SetPropertyBlock(_mpbA);
